...
from app.merge.docx_merge import merge_or_standalone_docx, sow_model_to_flat, standalone_docx_from_flat
    ...
    if not ws.active_template_asset_id:
        try:
            preamble = (
                ...
                "Upload a .docx template and set it as active to merge into your agency layout."
            )
